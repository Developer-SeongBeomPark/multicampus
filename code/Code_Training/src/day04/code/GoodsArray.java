...
class Goods {
	...
	String getName() {return name; } // 상품 이름 반환
	int getPrice() {return price; } // 상품 가격 반환
	int getNumberOfStock() {return numberOfStock; } // 상품 재고 반환
	int getSold() {return sold; } // 팔린 수량 반환
}