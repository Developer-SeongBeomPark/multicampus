...
public class APIExamObjdet {
    ...
    public static void main(String[] args) {
        ...
        String clientId = "upt5k9gxd4";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "THcgqEIozmatu3kiSrK4Z5MmL33KLc9yYrrTmJDn";//애플리케이션 클라이언트 시크릿값";
 
        try {
            String paramName = "image"; // 파라미터명은 image로 지정
            String imgFile = "C:\\deploy\\OCR\\sample1.jpg";
