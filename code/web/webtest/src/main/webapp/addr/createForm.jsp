...
<form class="form-horizontal" 
  ...
  <div class="form-group">
    ...
    <div class = "col-sm-4">
    	<button class = "btn" type = "button"  onclick="sample6_execDaumPostcode()">주소 찾기</button>
  	</div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" name="address" id="sample6_address" class="form-control" placeholder="주소">
    </div>
  </div>
